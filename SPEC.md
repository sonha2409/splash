...
**Last completed feature**: 9.1 XDG directory setup
...
| 8.12 | Brace grouping | `{ commands; }` — run in current shell. | `DONE` | 2026-03-30 | New BraceGroupCommand AST node; no fork, runs in current context; env changes persist |
